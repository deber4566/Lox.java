...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    //variables will stay in environment as long as interpreter is running
    ...
    public Void visitReturnStmt(Stmt.Return stmt) {
        Object value = null; //return always defaults to NULL

        if (stmt.value != null) {   //if has a return value, we evaluate and return
    ...
    // Ex. var a;
    // print a;
    // this will return null since nothing declared
    @Override
    ...
    //evaluate expression for the call
    //then evaluate each argument expression and store in a list
